...
const Map<String, Map<String, String>> translations = {
  'es': {
    ...
    'cultural_extended_description':
        'Toledo alberga más de 100 monumentos catalogados. Desde restos romanos hasta edificios renacentistas, pasando por la arquitectura mudéjar única en el mundo. La influencia de las tres culturas se aprecia en cada detalle: las yeserías islámicas, los artesonados mudéjares, la decoración renacentista y los retablos barrocos.',
